...
import sys
sys.path.append('/home/oerttrprd61/bzr/openobject-server')
import openerp
...
# multiple locations)
# gets overwritten because we simply load the while config file
#conf['addons_path'] = '/home/openerp/addons/trunk,/home/openerp/web/trunk/addons'
conf.parse_config(['-c', '/etc/openerp/oerttrprd61.cfg'])
