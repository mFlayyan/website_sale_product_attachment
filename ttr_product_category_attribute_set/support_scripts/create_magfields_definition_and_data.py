...
for attribute_set in attribute_sets:
    ...
    attr_rel = {
       ...
       'aansluiting': [133, 'Air inlet', 'KEEP'],
       ...
       'safety_lights_power_source': [143, 'Power Source', '310'],
       ...
       'ip': [148, 'IP', 'KEEP'],
       'safety_lights_max_temperature_surface': [149, 'Max Temperature Surface', '192'],
       ...
       'stroke_saw_blade': [169, 'Stroke Blade', 'KEEP'],
       ...
       'lifting_capacity': [176, 'Lifting Capacity', 'KEEP'],
       ...
       'max_water_inlet_temperature': [189, 'Max water inlet temp', 'KEEP'],
       ...
       'cutting_depth': [207, 'Cutting Depth', '169'],
       'cutting_cap_mild_steel': [208, 'Cutting cap mild steel', '169'],
       'cutting_cap_aluminium': [209, 'Cutting cap aluminium', '169'],
       'cutting_cap_stainless_steel': [210, 'Cutting cap stainless steel', '169'],
       ...
       'pressure': [220, 'Pressure', '137'],
       'stroke': [221, 'Stroke', '169'],
       ...
       'shape': [228, 'Shape', 'DELETE'],
       'regulating_range': [229, 'Regulating Range', 'KEEP'],
       ...
       'cutting_range': [253, 'Cutting Range', '169'],
                ...
                if (attr_rel[attribute['code']][2] !='DELETE' and 
                    ...
                    for key in attr_rel:
                        if str(attr_rel[key][0]) == attr_rel[attribute['code']][2]:
                            ...
                            break
                    model_string = (
                            "# MIGRATION NOTE: the data from field %s"
                            "should be moved to field %s at migration time"
